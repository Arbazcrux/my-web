...
<section class="serviceAc">
  ...
  <div class="container">
    ...
    <div class="bgAc">
      <div class="side">
      <h1 class="electrician">AC & Refrigrator<br> Man</h1>
  <p class="electrician">Book verified & skilled A.C technicians to get a new Air conditioner installed or your old one serviced or refilled with gas within a few seconds.</p>
</div>
...
<div class="form">
        ...
        <select class="select" name="category"><option>Choose category</option><option>AC Man</option></select>
