...
<link rel="stylesheet" type="text/css" href="css/mason.css">
...
<section class="serviceMason">
  ...
  <div class="container">
    ...
    <div class="bgMason">
      <div class="side">
      <h1 class="electrician">Mason</h1>
  <p class="electrician">Book masons for construction and tiling/flooring purposes. Masons at Sukoon are 100% verified and available on same day as of booking to ensure your home improvement tasks are never delayed</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        <form action="mason.php" method="post"> 
        ...
        <select class="select" name="category"><option>Choose category</option><option>Mason</option></select>
