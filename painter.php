...
<section class="servicePainter">
  ...
  <div class="container">
    ...
    <div class="bgPaint">
      <div class="side">
      <h1 class="electrician">Painter</h1>
  <p class="electrician">Book painters for renovation tasks and give your home/office a new look. Our painters are also background verified, at your doorstep within 6-8 hours of booking and have a know-how of latest trends (theme walls, wallpapers, texture painting etc).</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        ...
        <select class="select" name="category"><option>Choose category</option><option>Painter</option></select>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="tab-pane fade" id="signup">
            <form class="form-horizontal" action="painter.php" method="post">
            <fieldset>
            <!-- Sign Up Form -->
