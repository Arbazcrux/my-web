...
<section class="service">
  ...
  <div class="container">
    ...
    <div class="bgElect">
      <div class="side">
      <h1 class="electrician">Electrician</h1>
  <p class="electrician">Book trusted and expert electricians for all electrical installation and repair tasks. All electricians are verified, skilled in wiring and electrical knowledge as well as punctual</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        <form action="electracian.php" method="post">
        ...
        <select class="select" name="category"><option>Choose category</option><option>Electrician</option></select>
