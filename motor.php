...
<section class="serviceMotor">
  ...
  <div class="container">
    ...
    <div class="bgMotor">
      <div class="side">
      <h1 class="electrician">Motor Repairing</h1>
  <p class="electrician">Let us come to you for repairs. Our experienced technicians can perform electric motor repair—including service support for the elevator industry—as well as remanufacturing and preventative maintenance.</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        ...
        <select class="select" name="category"><option>Choose category</option><option>Motor Repairing</option></select>
