...
<link rel="stylesheet" type="text/css" href="css/plumber.css">
...
<section class="serviceplum">
  ...
  <div class="container">
    ...
    <div class="bgPlumber">
      <div class="side">
      <h1 class="electrician">Plumber</h1>
  <p class="electrician">Book plumbers for all your plumbing/pipeline repair and installation tasks. All our plumbers are background verified, arrive within 6-8 working hours of booking and are skilled to ensure a safe and swift experience for you..</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        ...
        <select class="select" name="category"><option>Choose category</option><option>Plumber</option></select>
