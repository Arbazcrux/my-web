...
<section class="serviceCar">
  ...
  <div class="container">
    ...
    <div class="bg">
      <div class="side">
      <h1 class="electrician">Carpenter</h1>
  <p class="electrician">Book carpenters for your furniture repair and installation/fixation issues. Our carpenters are also experienced in making new furniture items from the scratch. All carpenters are verified, punctual and adamant to provide you convenience.</p>
</div>
<div class="form">
        <h1>Order Now</h1>
        ...
        <select class="select" name="category"><option>Choose category</option><option>Carpenter</option></select>
